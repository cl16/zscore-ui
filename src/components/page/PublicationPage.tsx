...
function PublicationPage() {
    ...
    const {
        ...
        error: publicationDetailsIsError,
    } = useGetPublicationById(pubId); // TODO: How should an undefined pubID be handled here and on this page overall?

    const formPatterns: FormPatternSet<
        Omit<IPublicationPageForm, 'pubId' | 'gameId' | 'pubNameContains'>
    > = {
                ...
                <form onSubmit={submitForm}>
                    <div>
                        <div>
                            ...
                            <input
                                name={'gameTitleContains'}
                                className={
                                    formValidity.gameTitleContains
                                        ? 'text-input'
                                        : 'text-input-invalid'
                                }
                                type={'textbox'}
                                value={formData.gameTitleContains}
                                onChange={handleFormDataChange}
                            />
                            {formValidity.gameTitleContains ? null : (
                                <span>formPatterns.gameTitleContains</span>
                            )}
                        </div>
                        <div>
                            ...
                            <input
                                name={'minScore'}
                                className={
                                    formValidity.minScore ? 'text-input' : 'text-input-invalid'
                                }
                                type={'textbox'}
                        ...
                        <div>
                            ...
                            <input
                                name={'maxScore'}
                                className={
                                    formValidity.maxScore ? 'text-input' : 'text-input-invalid'
                                }
                                type={'textbox'}
                        ...
                        <div>
                            ...
                            <input
                                name={'minZscore'}
                                className={
                                    formValidity.minZscore ? 'text-input' : 'text-input-invalid'
                                }
                                type={'textbox'}
                                value={formData.minZscore}
                                onChange={handleFormDataChange}
                            />
                        ...
                        <div>
                            ...
                            <input
                                name={'maxZscore'}
                                className={
                                    formValidity.maxZscore ? 'text-input' : 'text-input-invalid'
                                }
                                type={'textbox'}
                                value={formData.maxZscore}
                                onChange={handleFormDataChange}
                            />
                        ...
                        dataTableConfig={{
                            columns: [
                                { accessor: 'game_title', label: 'Title' },
                                {
                                    accessor: 'date',
                                    label: 'Date',
                                    modifier: (val: string) => val.split('T')[0],
                                },
