...
function PublicationListPageOld() {
        ...
        <>
            <div className={'page-body-main'}>
                ...
                <div className={'table-container page-tl-container'}>
                    data === null ? <div>Nothing to see here!</div> :
                    <DataTable<IPublication> content={data} config={{
                        columns: [
...
export default PublicationListPageOld;